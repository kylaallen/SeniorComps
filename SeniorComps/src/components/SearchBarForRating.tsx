...
interface SearchBarForRatingProps {
  name: string;
  major: string;
}

const SearchBarForRating: React.FC = () => {
  const [searchInput, setSearchInput] = useState<string>("");

  const classes: SearchBarForRatingProps[] = [
  ...
  return (
    <div className="SearchBarForRating">
      <input
        className="bar"
        type="search"
        placeholder="Search here to rate a class"
...
export default SearchBarForRating;
